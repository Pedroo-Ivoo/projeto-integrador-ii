...
from utils import cadastro_ativo, perfis_permitidos, formatar_nome, verifica_email, enviar_confirmacao
...
def cadastro_motoristas():
    try:
        ...
        if request.method == "GET":
            ...
            # nome_recebido = request.form.get('nome', "").strip()
            # sobrenome_recebido = request.form.get('sobrenome', "").strip()
