...
from models import Usuarios, Regioes, Motoristas, Pais, Alunos, Veiculos, AlocacaoViagens, AlocacaoAlunos, RegistroPonto, Funcionario  # Importe todas as suas classes de modelo aqui
